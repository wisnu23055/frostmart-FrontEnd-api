...
export default function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoadingStep("Menyimpan detail produk...");
    ...
    try {
      ...
      const hasImages = imageFile || imageFile2 || imageFile3 || imageFile4;
      if (hasImages && newProduct.id) {
        ...
        await axiosInstance.post(`/products/photo/${newProduct.id}`, imgFormData, {
      ...
      alert(error.response?.data?.message || "Terjadi kesalahan saat menambah produk.");
    } finally {
